...
from core.nets.human_nerf.ptsdistrefiener import PtsRefiner

from pytorch3d import ops


# 这份network_ptsrefinedist
...
#         print("inputnet,",inputnet.shape)
    ...
    def pts_refine(self,pts,dist,idx):
        idx = idx/6890
        inputnet = torch.cat([pts,dist,idx],dim=1)
#         print("inputnet,",inputnet.shape)
        relation_pts = self.ptsdecoder(inputnet)
        refine_pram = 0.03
...
#         print("ptsweight_sum,",ptsweight_sum)
        ...
        cnl_pts = self.pts_refine(cnl_pts,dist,idx)
        # exit()
